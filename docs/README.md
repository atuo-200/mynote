...
![](http://latex.codecogs.com/gif.latex?h_\theta(x)%20=%20\theta_0%20+%20\theta_1x_1%20+%20\cdots%20+%20\theta_nx_n)

参数向量的维度为n + 1，在特征向量中添加 x0 = 1 后，其维度也变为n + 1，则运用线性代数，可简化h

<img src="http://latex.codecogs.com/gif.latex?h_\theta(X) = \left[
 \begin{matrix}
...
<center><img src="http://latex.codecogs.com/gif.latex?J(\theta_0,\theta_1\cdots\theta_n) = \frac{1}{2m}\sum_{i=1}^{m}{(h_\theta(x^i) - y^i).x^i_j}" /></center>

则多变量梯度下降公式为

<center><img src="http://latex.codecogs.com/gif.latex?\theta_j := \theta_j - \alpha\frac{\varphi}{\varphi\theta_j}J(\theta_0,\theta_1\cdots\theta_n)" /></center>

解出偏导得

<center><img src="http://latex.codecogs.com/gif.latex?\theta_j := \theta_j - \alpha\frac{1}{m}\sum_{i=1}^{m}{(h_\theta(x^i) - y^i).x^i_j}" /></center>
...
<center><img src="http://latex.codecogs.com/gif.latex?h_\theta(x) = \theta^Tx" /></center>

则得到同时更新参数的向量化实现

<center><img src="http://latex.codecogs.com/gif.latex?\theta = \theta - \alpha\frac{1}{m}(X^T(X\theta - y))" /></center>
...
![image.png](https://i.postimg.cc/YS9gqnMt/image.png)
...
<center><img src="http://latex.codecogs.com/gif.latex?一个二次方模型：h_\theta(x) = \theta_0 + \theta_1x + \theta_2x^2" /></center>

<center><img src="http://latex.codecogs.com/gif.latex?一个三次方模型：h_\theta(x) = \theta_0 + \theta_1x + \theta_2x^2 + \theta_3x^3" /></center>

<center><img src="http://latex.codecogs.com/gif.latex?x_i := \frac{x_i - average(x)}{maximum(x) - minimun(x)},使得x_i ∈ (-1,1)" /></center>

<center><img src="http://latex.codecogs.com/gif.latex?一个平方根模型：h_\theta(x) = \theta_0 + \theta_1x + \theta_2x^2 + \theta_2\sqrt{x}" /></center>
...
<center><img src="http://latex.codecogs.com/gif.latex?\theta = (X^TX)^-1X^Ty" /></center>

<img src="http://latex.codecogs.com/gif.latex?X^T：矩阵的转置" />矩阵的转置

<img src="http://latex.codecogs.com/gif.latex?X^-1：矩阵的逆矩阵" />矩阵的逆矩阵
...
<img src="http://latex.codecogs.com/gif.latex?h_θ(x) = g(z) = g(θ^Tx)" />
...
![](https://i.bmp.ovh/imgs/2020/04/34616929e7ed969e.png)
...
![](http://latex.codecogs.com/gif.latex?h_θ(x) < 0.5 \rightarrow y = 0)

再来看看sigmoid函数的图像

![image-20200307135336255](.\image\image-20200307135336255.png)

<center>![](https://i.bmp.ovh/imgs/2020/04/2d2c233bfc9723e7.png)</center>

![image-20200307142904885](.\image\image-20200307142904885.png)

![](https://i.bmp.ovh/imgs/2020/04/0541a0afa6928270.png)



上面讨论了逻辑回归模型中线性拟合的例子，下面则是一个多项式拟合的例子

![](http://latex.codecogs.com/gif.latex?h_%CE%B8(x)%20=%20g(%CE%B8_0%20+%20%CE%B8_1x_1%20+%20%CE%B8_3x_1^2%20+%20%CE%B8_4x_2^2))

![](https://i.postimg.cc/L4LLnybR/image.png)

这样我们可以在原点处得到一个单位圆作为决策边界

![](https://i.postimg.cc/h4rNW014/image.png)
...
![](https://i.bmp.ovh/imgs/2020/04/e9f8cf1f4ee9f6c2.png)

但逻辑回归算法中

![](http://latex.codecogs.com/gif.latex?h_\theta(x)%20=%20g(\theta^Tx))
...
![](https://i.bmp.ovh/imgs/2020/04/d82a43abd67c7785.png)
...
​														分类器定义：![](http://latex.codecogs.com/gif.latex?h_%CE%B8^i(x)%20=%20P(y%20=%20i|x;%CE%B8)%EF%BC%8Ci%20=%20(1,2...k))
...
​																		![](http://latex.codecogs.com/gif.latex?y%20=%20max(h_%CE%B8^i(x)))
...
![](http://latex.codecogs.com/gif.latex?%CE%B8_0%20+%20%CE%B8_1x%20+%20%CE%B8_2x^2%20+%20%CE%B8_3x^3%20+%20%CE%B8_4x^4)

为了保留各个参数的信息（这是使用正则化的目的），不修改假设函数，改而修改代价函数

![](https://i.bmp.ovh/imgs/2020/04/26ac4383cc523911.png)
...
![](https://i.bmp.ovh/imgs/2020/04/88b6bbd3eac673aa.png)

其中

![image-20200310155418245](https://i.postimg.cc/3r9188fm/image.png)
...
![image-20200311191309991](image\image-20200311191309991.png)
...
![image-20200311192929535](image\image-20200311192929535.png)
...
![](http://latex.codecogs.com/gif.latex?%20\alpha^2%20=%20g(%CE%B8^1%CE%B1^1))

![](http://latex.codecogs.com/gif.latex?%20h_%CE%B8(x)%20=%20a^3%20=%20g(%CE%B8^2%CE%B1^2))
...
![](http://latex.codecogs.com/gif.latex?\theta_0%20+%20\theta_1x_1%20+%20\theta_2x_2%20+%20\theta_3x_1x_2%20+%20\theta_4x_1^2%20+%20\theta_5x_2^2%20+%20...)


我们可以用一系列的新的特征 f 来替换模型中的每一项，例如令

![](http://latex.codecogs.com/gif.latex?f_1%20=%20%F0%9D%91%A5_1,f_2%20=%20%F0%9D%91%A5_2,f_3%20=%F0%9D%91%A5_1%F0%9D%91%A5_2,f_4%20=%20%F0%9D%91%A5_1^2,f5%20=%20%F0%9D%91%A5_2^2)

而得到

![](http://latex.codecogs.com/gif.latex?%E2%84%8E\theta(%F0%9D%91%A5)%20=%20%20\theta_1f_1%20+%20%20\theta_2f_2+...+%20\theta_nf_n)
...
![](http://latex.codecogs.com/gif.latex?(x^1,y^1),(x^2,y^2)%EF%BC%8C(x^3,y^3)%E2%8B%AF(x^m,y^m))

我们就将每个样本作为一个标记点

![](http://latex.codecogs.com/gif.latex?l^1=x^1%EF%BC%8C,l^2=x^2%EF%BC%8C,l^3=x^3%E2%8B%AF,l^m=x^m)

则对于某个样本 ，我们计算其与各个标记点的距离

![](http://latex.codecogs.com/gif.latex?f_1^i=sim(x^i,l^1))

![](http://latex.codecogs.com/gif.latex?f^i_2=sim(x^i,l^2))

​																						  ...

![](http://latex.codecogs.com/gif.latex?f^i_m=sim(x_i,l_3))
...
![](http://latex.codecogs.com/gif.latex?\frac{1}{2}\sum_{j%20=%201}^{n}{%CE%B8_j^2})
...
![](https://i.bmp.ovh/imgs/2020/04/d36235a43cf0000c.png)
...
[![image.png](https://i.postimg.cc/zfkLPdPn/image.png)](https://postimg.cc/d7Lth9F1)
